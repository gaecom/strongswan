...
METHOD(child_cfg_t, get_sa_mark, mark_t,
	private_child_cfg_t *this, bool inbound)
{
	...
	private_child_cfg_t *this, child_cfg_t *other_pub)
{
	...
	return this->options == other->options &&
		...
		this->sa_mark_in.value == other->sa_mark_in.value &&
		this->sa_mark_in.mask == other->sa_mark_in.mask &&
		this->sa_mark_out.value == other->sa_mark_out.value &&
		this->sa_mark_out.mask == other->sa_mark_out.mask &&
		this->tfc == other->tfc &&
